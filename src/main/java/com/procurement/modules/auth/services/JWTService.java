...
public class JWTService {
    ...
    public String generateToken(String email, Set<String> roles, Set<String> permissions) {
        ...
        return Jwts.builder().subject(email).claim("roles", roles).claim("permissions", permissions)
                .issuedAt(now)
    ...
    public JwtUserPrincipal extractPrincipal(String token) {
        ...
        return new JwtUserPrincipal(claims.getSubject(), extractStringSet(claims, "roles"),
    ...
    private Set<String> extractStringSet(Claims claims, String key) {
        ...
        if (value instanceof Set<?> set) {
            return set.stream().map(String::valueOf)
